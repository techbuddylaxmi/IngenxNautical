...
sap.ui.define(
    ...
    function (BaseController, Token, Filter, FilterOperator) {
      ...
      return BaseController.extend("com.ingenx.nauti.chartering.controller.ChangeChartering", {
        ...
        // value help for voyage
        voyageNo: function () {
          var oView = this.getView();
  
  
          if (!this._voyageNum) {
            this._voyageNum = sap.ui.xmlfragment(oView.getId(), "com.ingenx.nauti.transactiondashboard.fragments.voyageChartering", this);
            oView.addDependent(this._voyageNum);
          }
          this._voyageNum.open();
        ...
        onValueHelpClosevoy: function (oEvent) {
          ...
          this.byId("Input1").setValue(oSelectedItem.getTitle());
          // this.byId("VoyageNo").setValue(oSelectedItem.getTitle());
          var loc = this.getView().byId("Input1");
          ...
          // var VoyTypdata = filter[0].Voyty
          // var VesselTypdata = filter[0].
  
  
          var VoyageName = this.getView().byId("voyname");
          // var VoyageType = this.getView().byId("VoyageType");
          // var VesselType = this.getView().byId("VesselType")
          // console.log("hello",VoyageType);
          VoyageName.setValue(VoyNamedata);
          // VoyageType.setValue(VoyTypdata);
        ...
        // // value help for purchase group
        // purchaseGroupValueHelp: function () {
        //   var oView = this.getView();
  
  
        //   if (!this._opurchaseGroup) {
        //     this._opurchaseGroup = sap.ui.xmlfragment(oView.getId(), "com.ingenx.nauti.transactiondashboard.fragments.purchaseGroup", this);
        ...
        // },
        // // value help for purchase org
        // purchaseOrgValueHelp: function () {
        //   var oView = this.getView();
  
  
        //   if (!this._opurchaseOrg) {
        //     this._opurchaseOrg = sap.ui.xmlfragment(oView.getId(), "com.ingenx.nauti.transactiondashboard.fragments.purchaseOrg", this);
        ...
        // },
        // // value help for payment Terms
        // paymentTermValueHelp: function () {
        //   var oView = this.getView();
  
  
        //   if (!this._oPaymentTerm) {
        //     this._oPaymentTerm = sap.ui.xmlfragment(oView.getId(), "com.ingenx.nauti.transactiondashboard.fragments.paymentTerm", this);
        ...
        // },
        // value help for fetching chartering data
        ...
        onCharteringValueHelpClose: function (oEvent) {
          ...
          // if (!getVendorModelData.some(x => x.Lifnr === vendorData)) {
          //   oTable.setVisible(false);
          // }
          // console.log(this.getView().getModel("vendonModel1").getData());
